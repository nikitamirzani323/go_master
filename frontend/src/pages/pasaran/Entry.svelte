<script>
    ...
    export let token = "";
    export let master = "";
    export let pasaran_nmpasarantogel_field = "";
    export let pasaran_tipepasaran_field = "";
    export let pasaran_urlpasaran_field = "";
    export let pasaran_pasarandiundi_field = "";
    export let pasaran_jamtutup_field = "";
    export let pasaran_jamjadwal_field = "";
    export let pasaran_jamopen_field = "";
    export let pasaran_create_field = "";
    export let pasaran_update_field = "";
    ...
    async function SaveLimitline() {
        ...
        if (pasaran_limitline4d_field == "") {
            flag = true;
            msg += "The Limitline 4D is required\n";
        }
        ...
        if (pasaran_limitline2dd_field == "") {
            flag = true;
            msg += "The Limitline 2DD is required\n";
        }
        if (pasaran_limitline2dt_field == "") {
            flag = true;
            msg += "The Limitline 2DT is required\n";
        }
        if (flag == false) {
            const res = await fetch("/api/savepasaranlimitline", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: "Bearer " + token,
    ...
    async function save432d() {
        ...
        if (pasaran_win4d_nodisc_432d_field == "") {
            flag = true;
            msg += "The Win 4D FULL is required\n";
        }
        if (pasaran_win3d_nodisc_432d_field == "") {
            flag = true;
            msg += "The Win 3D FULL is required\n";
        }
        if (pasaran_win3dd_nodisc_432d_field == "") {
            flag = true;
            msg += "The Win 3DD FULL is required\n";
        }
        if (pasaran_win2d_nodisc_432d_field == "") {
            flag = true;
            msg += "The Win 2D FULL is required\n";
        }
        if (pasaran_win2dd_nodisc_432d_field == "") {
            flag = true;
            msg += "The Win 2DD FULL is required\n";
        }
        if (pasaran_win2dt_nodisc_432d_field == "") {
            flag = true;
            msg += "The Win 2DT FULL is required\n";
        }
    ...
    async function save5050Special() {
        let flag = false;
        let msg = "";
        css_loader = "display: inline-block;";
        msgloader = "Sending...";
    ...
    async function save5050Kombinasi() {
        let flag = false;
        let msg = "";
        css_loader = "display: inline-block;";
        msgloader = "Sending...";
    ...
    async function saveMacauKombinasi() {
        let flag = false;
        let msg = "";
        css_loader = "display: inline-block;";
        msgloader = "Sending...";
        ...
        <Col>
            <TabContent pills>
                <TabPane tabId="4-3-2" tab="4D/3D/2D" active>
                    <Panel height_body="700px" card_footer="false" css_body="700px;overflow:scroll;">
                        <slot:template slot="cheader">
                            <div class="float-end">
                                <button
                                    on:click={() => {
                            ...
                            <Row>
                                <Col xs="2">
                                    ...
                                    <div class="mb-3">
                                        <label
                                            for="exampleForm"
                                            class="form-label">Max Bet</label
                                        >
                                        <input
                            ...
                            <Row>
                                ...
                                <Col xs="2">
                                    <div class="mb-3">
                                        <label
                                            for="exampleForm"
                                            class="form-label">Win AS(x)</label
                                        >
                                        <input
                                    ...
                                    <div class="mb-3">
                                        <label
                                            for="exampleForm"
                                            class="form-label">Win Kop(x)</label
                                        >
                                        <input
